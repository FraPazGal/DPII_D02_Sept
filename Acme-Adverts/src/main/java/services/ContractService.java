...
public class ContractService {
	...
	public Contract findOneToDelete(final int Id) {
	...
	public Contract sign(final int id) {
		...
		final Collection<File> files = this.billboardFileService.findAllFilesByContract(id);
	...
	public void deleteAccount(final Request r) {
		...
		if (!con.isEmpty())
			for (final Contract c : con)
				this.deleteFilesFromContract(c);
		this.contractRepository.deleteInBatch(con);
	}
	
	private void deleteFilesFromContract (Contract contract) {
		this.billboardFileService.deleteBillboardFilesFromContract(contract.getId());
		this.infoFileService.deleteInfoFilesFromContract(contract.getId());
		this.TVFileService.deleteTVFilesFromContract(contract.getId());
