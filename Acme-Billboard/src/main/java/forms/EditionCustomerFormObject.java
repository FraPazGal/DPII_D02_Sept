...
public class EditionCustomerFormObject {
	...
	public EditionCustomerFormObject() {

	}

	public EditionCustomerFormObject(final Customer customer) {
		this.id = customer.getId();
		this.version = customer.getVersion();
		this.username = customer.getUserAccount().getUsername();
		this.password = customer.getUserAccount().getPassword();
