...
<form:form modelAttribute="registerCustomerFormObject"
	action="customer/customer/register.do"
	...
	<fieldset>
		...
		<div>
			...
			<strong><form:label path="vat">
					<spring:message code="customer.vat" />
				</form:label></strong>
			<form:input path="vat" />
		</div>
	...
	<fieldset>
		...
		<div>
			...
			<strong><form:label path="make">
				...
				</form:label></strong> <select name="make">
				<jstl:forEach var="item" items="${makers}">
